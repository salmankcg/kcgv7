...
var workType = Cookies.get('work_type');
...
function init(){
    ...
    $filter.find('.item').on('click', function(e){
        ...
        var subContainer = ($(this).closest('.works-filter-menu > li.active').find('.filter-dropdown').length > 0) ? $(this).closest('.works-filter-menu > li.active').find('.filter-dropdown').outerWidth() : '';
        var subOuter = ($(this).closest('.works-filter-menu > li.active').find('.filter-dropdown').length > 0) ? $(this).closest('.works-filter-menu > li.active').find('.filter-dropdown li').last().position().left : '';
        if(subOuter > subContainer) {
            $('.work-filter-dropdown-nav').show();
        } else {
            $('.work-filter-dropdown-nav').hide();
        }
    ...
    if(workType != '') {
        $('.works-filter-menu .item[data-id="'+workType+'"]').trigger('click');
    }
